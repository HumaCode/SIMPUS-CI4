        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?= (session()->get('foto') == '') ? base_url('logo/noimages.png') : base_url('img/user/' . session()->get('foto')) ?>" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block"><?= session()->get('nama_siswa') ?></a>
                        <?php if (session()->get('verifikasi') == 0) { ?>
                            <small><a href="#"><i class="fas fa-times-circle text-danger"></i> Belum Terverifikasi</a></small>
                        <?php } else { ?>
                            <small><a href="#"><i class="fas fa-check-circle text-success"></i> Terverifikasi</a></small>
                        <?php } ?>
                    </div>
                </div>
